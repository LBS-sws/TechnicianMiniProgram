			...
			<view class="new_card" @click="job_detail(item)">
				<view class="new_card_title">
					...
					<span v-if="item.status">
						<span >
							<view class="new_card_title_right" style="color: #07C160;">已审核</view>
						</span>
	...
	export default {
		data() {
			return {
				...
				jobs:[{"status":"已审核","id":3614873,"type":1,"job_date":"2024-09-26","job_start_time":"07:51:41","job_end_time":"16:51:47",
				"first_job_flag":"首次服务","customer_code":"123-ZY","name_zh":"非常好吃的","addr":"珠海市香洲区翠前北路3街森宇国际2202",
				"customer_type":139,"service_name":"灭虫"}],
				jobid:"",
				jobtype:"",
				servicetype:"",
				list:[
