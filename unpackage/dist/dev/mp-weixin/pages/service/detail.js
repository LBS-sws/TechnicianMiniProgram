...
/***/ 200:
/*!******************************************************************************************************!*\
  !*** D:/phpstudy_pro/WWW/qianduan/TechnicianMiniProgram/main.js?{"page":"pages%2Fservice%2Fdetail"} ***!
  \******************************************************************************************************/
...
var _detail = _interopRequireDefault(__webpack_require__(/*! ./pages/service/detail.vue */ 201));
// @ts-ignore
...
/***/ 201:
/*!***********************************************************************************!*\
  !*** D:/phpstudy_pro/WWW/qianduan/TechnicianMiniProgram/pages/service/detail.vue ***!
  \***********************************************************************************/
/*! no static exports found */
...
/* harmony import */ var _detail_vue_vue_type_template_id_3000c024___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./detail.vue?vue&type=template&id=3000c024& */ 202);
...
/***/ 202:
/*!******************************************************************************************************************!*\
  !*** D:/phpstudy_pro/WWW/qianduan/TechnicianMiniProgram/pages/service/detail.vue?vue&type=template&id=3000c024& ***!
  \******************************************************************************************************************/
...
try {
  components = {
    ...
    clToast: function () {
      return Promise.all(/*! import() | cl-uni/components/cl-toast/cl-toast */[__webpack_require__.e("common/vendor"), __webpack_require__.e("cl-uni/components/cl-toast/cl-toast")]).then(__webpack_require__.bind(null, /*! @/cl-uni/components/cl-toast/cl-toast.vue */ 480))
    },
    clIcon: function () {
...
/***/ 204:
/*!************************************************************************************************************!*\
  !*** D:/phpstudy_pro/WWW/qianduan/TechnicianMiniProgram/pages/service/detail.vue?vue&type=script&lang=js& ***!
  \************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var _default = {
  ...
  methods: {
    showConfirmationDialog: function showConfirmationDialog(title, content, onConfirm, onCancel) {
      uni.showModal({
        title: title,
        content: content,
        showCancel: false,
      ...
      uni.request({
        ...
        success: function success(res) {
          if (res.data.code == 200) {
            ...
            if (_this2.service.remarks && !_this2.acknowledged && _this2.service.status != 3) {
              // 判断 acknowledged 的值
              _this2.showConfirmationDialog('客户要求提示', _this2.service.remarks, function () {
                _this2.acknowledged = true; // 用户已知晓
              }, function () {
                uni.navigateBack();
              });
            }
    ...
    start: function start() {
      ...
      if (!this.service.start_time || this.service.start_time == '00:00:00') {
        uni.navigateTo({
          url: "/pages/sign/sign?jobid=" + this.jobid + "&jobtype=" + this.jobtype + "&lat=" + this.service.lat + "&lng=" + this.service.lng + "&addr=" + this.service.customer.addr
        });
      }
      // }
    },
    ...
    // 点击拨打电话
    makePhoneb: function makePhoneb() {
      uni.makePhoneCall({
    ...
    history: function history() {
      uni.redirectTo({
        url: "/pages/history/list?job_type=" + this.jobtype + "&job_date=" + this.service.job_date + "&service_type=" + this.service.service_type + "&job_id=" + this.jobid
      });
    },
    //修改技术员备注
    update_remarks: function update_remarks() {
      var _this3 = this;
      ...
      this.$refs.confirm2.open({
        ...
        var params = {
          ...
          contractnumber: _this3.service.ContractNumber,
          customerid: _this3.service.CustomerID,
          servicetype: _this3.service.ServiceType,
          techremarks: _this3.TechRemarks
        };
        uni.request({
          url: "".concat(_this3.$baseUrl, "/savetechremarks"),
          header: {
            'content-type': 'application/x-www-form-urlencoded',
            'token': uni.getStorageSync('token')
          },
          ...
          success: function success(res) {
            uni.hideLoading();
            if (res.data.code == 1) {
              _this3.service.TechRemarks = _this3.TechRemarks;
              _this3.$refs.toast.open(_this3.TechRemarks ? "\u4FEE\u6539\u6210\u529F\uFF01" : "填写为空！");
            } else {
              _this3.$refs.toast.open("修改失败！");
            }
          },
          fail: function fail(err) {
            console.log(res);
...
/***/ 206:
/*!********************************************************************************************************************!*\
  !*** D:/phpstudy_pro/WWW/qianduan/TechnicianMiniProgram/pages/service/detail.vue?vue&type=style&index=0&lang=css& ***!
  \********************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
